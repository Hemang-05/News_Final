                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 8.0,), // btw trending news image and text card
                      Column(
                        children: [
                          Container(
                            width: MediaQuery.of(context).size.width/2,
                            child: Text(
                              "lopren ipsom loterm  eiurue bfhjsdfh kakdkdskk.",
                              style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.w500,
                                  fontSize: 17.0),
                          ...
                          SizedBox(width: 7.0,), // btw both text in trending news Section
                          Container(
                            width: MediaQuery.of(context).size.width/2,
                            child: Text(
                              "Text changes for this flan fana bfhjsdfh kakdkdskk.",
                              style: TextStyle(
